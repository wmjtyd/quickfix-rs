...
void Application::onMessage(const FIX42::ExecutionReport &executionReport,
                            const FIX::SessionID &sessionId) {
  // auto nowUtc =
  ...
  std::cout << std::endl
            ...
            << "onMessage: FIX42::ExecutionReport:" << executionReport
            << std::endl;
}
...
void Application::NewOrderSingle() {
  ...
  FIX42::NewOrderSingle newOrderSingle(
      FIX::ClOrdID(orderId), FIX::HandlInst('1'), FIX::Symbol("BTCUSDT"),
      FIX::Side(FIX::Side_BUY), FIX::TransactTime(FIX::UTCTIMESTAMP()),
      // FIX::TransactTime(),
